...
<a href="Analysis/f/tiktok_engagement_by_timeslot_ratio.sql" style="font-size: 14px; color: #0077cc;">Engagement by timeslot source code</a>
<br><br>
...
<a href="Analysis/heatmap_engagement_by_timeslot.py" style="font-size: 14px; color: #0077cc;">Engagement by timeslot (heatmap) source code</a>
<br><br>
...
<a href="Analysis/heatmap_engagement_by_music_characteristic.py" style="font-size: 14px; color: #0077cc;">Engagement by music features (heatmap) source code</a>
<br><br>

<img width="1316" alt="image" src="https://github.com/user-attachments/assets/0bf64b13-a96a-4260-9a37-55f4a6e08bf3">
<a href="Analysis/tiktok_engagement_by_genres_ratio.sql" style="font-size: 14px; color: #0077cc;">Engagement by music features (heatmap) source code</a>
<br><br>
...
<a href="Analysis/trendline_scatter_popularity_vs_engagement.py" style="font-size: 14px; color: #0077cc;">Engagement by Popularity (Scatter) source code</a>
<br><br>

<img width="1353" alt="image" src="https://github.com/user-attachments/assets/7beb378f-13fe-4868-b8a7-69facb421d6b">
<a href="Analysis/tiktok_engagement_by_popularity_ratio.sql" style="font-size: 14px; color: #0077cc;">Engagement by Popularity source code</a>
<br><br>

<img width="1309" alt="image" src="https://github.com/user-attachments/assets/3fa61129-f03b-40d8-bc89-49b6c94034c2">
<a href="Analysis/trendline_scatter_rhythm_vs_engagement.py" style="font-size: 14px; color: #0077cc;">Engagement by Rhythm (Scatter) source code</a>
<br><br>

<img width="1388" alt="image" src="https://github.com/user-attachments/assets/a074e973-ac80-4996-a8cc-0e767d354e9c">
<a href="Analysis/tiktok_engagement_by_rhythm_ratio.sql" style="font-size: 14px; color: #0077cc;">Engagement by Rhythm source code</a>
<br><br>
